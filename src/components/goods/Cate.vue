    ...
    <el-card>
      ...
      >
        ...
        <template slot="opt" slot-scope="scope">
          <el-button size="mini" type="primary" class="el-icon-edit" @click="showEditCateDialog(scope.row)">编辑</el-button>
          <el-button size="mini" type="danger" class="el-icon-delete" @click="removeCate(scope.row.cat_id)">删除</el-button>
        </template>
      </tree-table>
...
export default {
  ...
  methods: {
    ...
    parentCateChange () {
      ...
      // 如果 selectedKeys 数组中的 length 小于 0，证明没有选中父级分类
